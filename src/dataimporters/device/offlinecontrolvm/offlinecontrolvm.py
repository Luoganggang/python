...
class DeviceOfflineControlVM(QueryDeviceBalance):
    def __init__(self):
        super(DeviceOfflineControlVM, self).__init__()
        self.set_log_level(self.LOGD)
        self.set_log_tag("DeviceOfflineControlVM")
    ...
    def execute(self):
        ...
        params = {"enableStatus":"1","faultStatus":"0","grantOpenStatus":"on","maintStatus":"0", \
            "vmStatus":"0","padStatus":"0","rows":"1","padClassify":"1","padPool":"1","storageType":"0"}
        ...
        # 导入到数据库
        self.write_cursor.execute('INSERT INTO device_offline_control_vm (log_time, total) VALUES (%s, %s)', \
            (current_tick, all_total))
        self.write_conn.commit()

if __name__ == "__main__":
    print ("Device Offline Control VM V1.0")
    print ("(C) 2019 Hunan MC Information Technology Co., Ltd.")
    print ("Authors: Shi Qizheng (shiqizheng@armvm.cn)")
    obj = DeviceOfflineControlVM()
